...
public class IOrderService_Order_OrderServiceFaultFault_FaultMessage extends java.lang.Exception {
    ...
    private main.services.OrderServiceStub.OrderServiceFaultE faultMessage;
    ...
    public void setFaultMessage(
        main.services.OrderServiceStub.OrderServiceFaultE msg) {
        faultMessage = msg;
    }

    public main.services.OrderServiceStub.OrderServiceFaultE getFaultMessage() {
        return faultMessage;
    }
}
